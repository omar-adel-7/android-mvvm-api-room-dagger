...
//                else
//                {
//                    if(objectOfArrayBeanName.equals(CertainBean.class.getName()))
//                    {
//                        Type listType = new TypeToken<ArrayList<CertainBean>>() {}.getType();
...
//                }
                ...
                Log.e("ExceptionLoadDataFromCache", ex.toString());
            }
        }
